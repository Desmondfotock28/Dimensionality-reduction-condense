...
class BasicBuffer:
    ...
    def push(self, state, obs, action, reward, next_state, next_obs, info):
        experience = (
            state,
            obs,
            action,
    ...
    def sample(self):
        ...
        state, obs, action, reward, next_state, next_obs, info = transition
        return (state, obs, action, reward, next_state, next_obs, info)
